...
namespace SOM
{
    public class Neuron   // создание класса нейрон
    {
        ...
        private double Gauss(Neuron win, int it)  // Распределение Гаусса
        {
        ...
        public double UpdateWeights(double[] pattern, Neuron winner, int it) // обновление весов
        {
            double sum = 0;
